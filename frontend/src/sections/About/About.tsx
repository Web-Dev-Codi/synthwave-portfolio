		...
		<div className="section-inner space-y-8">
			...
			<div className="section-panel retro-panel rounded-(--radius-panel) border border-(--color-border-soft) p-6 sm:p-8">
				<div className="grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-start">
					<div className="retro-panel neon-card floating-panel rounded-(--radius-panel) border border-(--color-border-soft) p-6 sm:p-8">
					...
					<div className="space-y-8">
						<div className="space-y-4 text-base leading-8 text-(--color-text-muted)">
